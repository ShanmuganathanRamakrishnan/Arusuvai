...
| `core/foods/`             | Built — models, templates, ifct_loader, recipe_loader, retention, portions, nutrition_of. 105 tests pass (transcript in the Phase 1 build message). Ingredient data is a hand-entered fixture set, not IFCT; see `data/raw/ifct/README.md`. |
